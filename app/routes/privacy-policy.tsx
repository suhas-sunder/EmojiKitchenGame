    ...
    <div className="my-20 flex flex-col items-center mx-10 justify-center gap-8 font-nunito text-defaultblue">
      <header className="max-w-[1200px]">
        ...
        <p className="flex flex-col gap-4 py-2">
          <span>
            This privacy notice for https://emojikitchengame.com ('we', 'us', or
          ...
          <ul className="flex list-inside list-disc flex-col gap-5 py-2 pl-5 dark:text-gray-400">
            <li>
              Visit our website at http://emojikitchengame.com, or any website
      ...
      <main className="flex max-w-[1200px] flex-col gap-8">
        ...
        <section className="flex flex-col gap-4">
          ...
          <p>
            ...
            Cookie Notice: http://emojikitchengame.com/cookiespolicy.
          </p>
          ...
          <p>
            ...
            <ul className="flex list-inside list-disc flex-col gap-5 py-2 pl-5 dark:text-gray-400">
              ...
              <li>
                ...
                http://emojikitchengame.com/cookiecollection.
              </li>
              <li>
        ...
        <section className="flex flex-col gap-4">
          ...
          <p>
            ...
            age 18, please contact us at admin@emojikitchengame.com.
          </p>
        </section>
        <section className="flex flex-col gap-4">
          <h2 className="flex py-2 text-2xl">
          ...
          <p>
            ...
            at any time by contacting us at admin@emojikitchengame.com.
          </p>
          <p>
        ...
        <section className="flex flex-col gap-4">
          ...
          <p>
            ...
            subject access request, by email at admin@emojikitchengame.com, or
          ...
          <p>
            ...
            our decision, please email us at admin@emojikitchengame.com. Within
        ...
        <section className="flex flex-col gap-4">
          ...
          <p>
            ...
            us at admin@emojikitchengame.com or contact us by post at:
          </p>
